...
All ontology settings live in [`ontology/config.yaml`](dataelf/domains/ai_index/modeling/ontology/config.yaml):
...
The config path defaults to the packaged file shown above; an explicit empty path is rejected.
